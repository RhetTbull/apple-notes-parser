...
class TestVersionAgnostic:
    """Tests that should work across all supported database versions."""
    ...
    def test_basic_data_loading(self, versioned_database, version_metadata):
        ...
        with AppleNotesDatabase(versioned_database) as db:
            ...
            expected_account = next((acc for acc in accounts if acc.name == version_metadata["account_name"]), None)
    ...
    def test_folder_hierarchy_structure(self, versioned_database, version_metadata):
    ...
    def test_applescript_id_construction(self, versioned_database, version_metadata):
    ...
    def test_password_protection_detection(self, versioned_database, version_metadata):
    ...
    def test_export_functionality(self, versioned_database, version_metadata):
...
class TestFutureVersionScalability:
    """Tests demonstrating how to add future database versions."""
    
    def test_version_fixture_extensibility(self):
    ...
    def test_parameter_expansion_example(self):
