...
class TestFolderHierarchy:
    ...
    def test_folder_path_construction(self, real_database):
        ...
        with AppleNotesDatabase(real_database) as db:
            ...
            assert folders_by_name["Folder"].get_path(folders_dict) == "Folder"  # Top-level folder
            assert folders_by_name["Folder2"].get_path(folders_dict) == "Folder2"  # Top-level folder
            assert folders_by_name["Subfolder"].get_path(folders_dict) == "Folder2/Subfolder"
            assert folders_by_name["Subsubfolder"].get_path(folders_dict) == "Folder2/Subfolder/Subsubfolder"
